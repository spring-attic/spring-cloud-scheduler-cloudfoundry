...
By default the integration tests are skipped unless you have the configuration
properties enumerated above in the environment along with the following:

----
# specifies the services required by the test app being deployed.
# the minimum service required to be enumerated is the PCF-Scheduler-Service
# for the configurated organization and space.
